...
<div id="add" class="modal fade">
    <div class="modal-dialog">
        <form action="/addCurriculum" method="get" role="form" class="form-horizontal" autocomplete="on"
              id="addCurriculum">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cprice" id="cprice" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cinfo" id="cinfo" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cperiod" id="cperiod" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" type="date" name="cstartTime" id="cstartTime" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" type="date" name="cendTime" id="cendTime" value=""
                                   required="required"/>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="cname" class="control-label col-lg-4">课程名：</label>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cuName" id="cuName" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cprice" class="control-label col-lg-4">价格：</label>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cuPrice" id="cuPrice" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cuInfo" id="cuInfo" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cnum" class="control-label col-lg-4">参与人数：</label>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cuNum" id="cuNum" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cperiod" class="control-label col-lg-4">课时数：</label>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="cuPeriod" id="cuPeriod" value=""
                                   required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <tr>
                ...
                <td>
                    <!-- <a href="" class="btn btn-info" name="update">修改</a> -->
                        <%--								href等号赋值不要加引号--%>
                    <a href="" onclick="evaluation(this,${curriculum.id})" class="btn btn-warning" data-toggle="modal"
                       data-target="#update">修改</a>
                </td>
                <td>
...
<div id="logout" align="right">
    <a href="/logout" style="padding-right: 30px">退出</a>
</div>
</body>
</html>
