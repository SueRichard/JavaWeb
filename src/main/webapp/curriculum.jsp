...
<html>
	...
	<body>
				...
				<form action="/addCurriculum" method="get" role="form" class="form-horizontal" autocomplete="on" id="addCurriculum">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label for="" class="control-label col-lg-4">简介：</label>
								<div class="col-lg-6">
		...
		<div id="update" class="modal fade">
			<div class="modal-dialog">
				<form action="/updateCurriculum" method="get" role="form" class="form-horizontal" autocomplete="on" id="updateCurriculum">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label for="cstartTime" class="control-label col-lg-4">开始时间：</label>
								<div class="col-lg-6">
									<input class="form-control" type="date" name="cuStartTime" id="cuStartTime" value="" required="required" />
								</div>
							</div>
							<div class="form-group">
								<label for="cendTime" class="control-label col-lg-4">结束时间：</label>
								<div class="col-lg-6">
									<input class="form-control" type="date" name="cuEndTime" id="cuEndTime" value="" required="required" />
								</div>
							</div>
						</div>
						<div class="modal-footer">
					...
					<c:forEach items="${curricula}" var="curriculum" varStatus="index">
						<tr>
							...
							<td>
								...
								<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#update">修改</button>
							</td>
							<td>
